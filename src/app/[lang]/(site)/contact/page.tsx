                ...
                <dd className="min-w-0">
                  ...
                  >
                    ...
                    <ArrowUpRight
                      size={13}
                      aria-hidden
                      className="shrink-0 translate-y-px text-ink-subtle transition-transform duration-fast ease-out-expo group-hover:-translate-y-0.5 group-hover:translate-x-0.5 rtl:-scale-x-100"
                    />
                  </a>
                </dd>
              </div>
